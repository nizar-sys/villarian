@extends('layouts.app')
@section('title', 'Tambah data villa')
...
@section('breadcrumb')
    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
        ...
        <li class="breadcrumb-item active">Tambah Data villa</li>
    </ol>
@endsection
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-transparent border-0">
                    ...
                    <form action="{{route('villas.store')}}" id="form-create-villa" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="pl-lg-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-nama_villa"
                                            ...
                                            placeholder="Nama Villa" name="nama_villa" value="{{ old('nama_villa') }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-alamat"
                                            ...
                                            placeholder="Alamat Villa" name="alamat" value="{{ old('alamat') }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="input-harga_sewa"
                                            ...
                                            placeholder="Harga Sewa Villa" name="harga_sewa" value="{{ old('harga_sewa') }}">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <button class="btn btn-success btn-sm" type="button" id="action-villa">Tambah</button>
